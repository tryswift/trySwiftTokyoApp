...
enum Lines: Equatable, Identifiable, CaseIterable {
  ...
  var region: MKCoordinateRegion {
    switch self {
      case .metroShibuya:
        return .init(center: .init(latitude: 35.657892, longitude: 139.703748), span: .init(latitudeDelta: 0.01, longitudeDelta: 0.01))
      case .jrShibuya:
        return .init(center: .init(latitude: 35.658575, longitude: 139.701499), span: .init(latitudeDelta: 0.01, longitudeDelta: 0.01))
      case .metroOmotesando:
        return .init(center: .init(latitude: 35.665222, longitude: 139.712543), span: .init(latitudeDelta: 0.01, longitudeDelta: 0.01))
    }
  }
